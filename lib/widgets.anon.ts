...
export interface Contract {
  ...
  leietype: string;
  sfUrl: string | null;
  // v80 (2026-09-26): se widgets.local.ts sin fyldige kommentar.
  kategori?: "ny" | "fornyet";
}
...
export const CONTRACTS: Contract[] = [
  ...
  { id: "c140", kunde: "Demokunde 278 AS", signeringsdato: "2026-09-18", startdato: "2026-09-23", arsbelop: 523200, bygg: "Vollsveien 13-19", kvm: 159, leietype: "Kontorleie", sfUrl: null, kategori: "ny" },
  { id: "c141", kunde: "Demokunde 29", signeringsdato: "2026-09-09", startdato: "2026-09-04", arsbelop: 690000, bygg: "Lilleakerveien 8", kvm: 163.3, leietype: "Husleie", sfUrl: null, kategori: "fornyet" },
  { id: "c142", kunde: "Demokunde 279", signeringsdato: "2026-09-09", startdato: "2026-09-01", arsbelop: 288120, bygg: "Arnstein Arnebergsvei 4", kvm: 0, leietype: "Husleie", sfUrl: null, kategori: "ny" },
  { id: "c143", kunde: "Demokunde 280", signeringsdato: "2026-09-01", startdato: "2026-09-01", arsbelop: 143856.74, bygg: "Vollsveien 13-19", kvm: 65.2, leietype: "Husleie", sfUrl: null, kategori: "fornyet" },
  { id: "c144", kunde: "Demokunde 281 AS", signeringsdato: "2026-09-01", startdato: "2026-09-01", arsbelop: 1050600, bygg: "Lilleakerveien 14", kvm: 511.6, leietype: "Kontorleie/Husleie", sfUrl: null, kategori: "ny" },
  { id: "c145", kunde: "Demokunde 282 AS", signeringsdato: "2026-08-28", startdato: "2026-09-01", arsbelop: 1986400, bygg: "Lilleakerveien 10", kvm: 601.9, leietype: "Husleie", sfUrl: null, kategori: "ny" },
  { id: "c146", kunde: "Demokunde 283 AS", signeringsdato: "2026-08-27", startdato: "2026-10-01", arsbelop: 1200000, bygg: "Lilleakerveien 8", kvm: 289.1, leietype: "Husleie", sfUrl: null, kategori: "fornyet" },
  { id: "c147", kunde: "Demokunde 284 AS", signeringsdato: "2026-08-26", startdato: "2026-10-01", arsbelop: 273703.02, bygg: "Lilleakerveien 8", kvm: 105.4, leietype: "Kontorleie/Lagerleie", sfUrl: null, kategori: "fornyet" },
  { id: "c148", kunde: "Demokunde 285 AS", signeringsdato: "2026-08-20", startdato: "2026-09-01", arsbelop: 280000, bygg: "Lilleakerveien 2 Garasje", kvm: 126.8, leietype: "Parkering", sfUrl: null, kategori: "ny" },
  { id: "c149", kunde: "Demokunde 286 AS", signeringsdato: "2026-08-18", startdato: "2026-07-01", arsbelop: 454581.82, bygg: "Lilleakerveien 14", kvm: 456.8, leietype: "Husleie", sfUrl: null, kategori: "ny" },
];
...
export interface ContractDetaljer {
  ...
  forrigeLeieforhold: string | null;
...
export const CONTRACT_DETALJER: Record<string, ContractDetaljer> = {
  c140: {
    ...
    saerligeBestemmelser: [
      "Leiefritak i innflyttingsperioden til og med 31.10.2026 (øvrige kostnader betales som avtalt).",
      "Rett til forlengelse i 2 år på markedsvilkår.",
      "Utleier planlegger en fremtidig sambruksordning for fellestjenester i «Lilleakerbyen» - egen tilleggsavtale ventes.",
    ],
    forrigeLeieforhold: null,
  ...
  c141: {
    ...
    garantibelop: null,
    saerligeBestemmelser: [
      "Erstatter tidligere avtale for 150 kvm i 5. etasje.",
      "Overtar lokalene etter Demokunde 281 AS, som flytter til 5. etasje i samme bygg (anslått 4. september 2026).",
      "Leietaker kan si opp med 6 måneders varsel etter 3 års leietid.",
      "Utleier planlegger en fremtidig sambruksordning for fellestjenester i «Lilleakerbyen».",
    ],
    forrigeLeieforhold: "Demokunde 281 AS - flyttet til 5. etasje i samme bygg (se egen kontrakt), anslått 04.09.2026.",
  ...
  c142: {
    ...
    etasje: "U",
    arealnavn: "3 rom + kjøkken og bad",
    ...
    garantibelop: null,
    saerligeBestemmelser: [
      "Boligleie underlagt husordensregler og antikvariske føringer (Byantikvaren) - ingen interiørendringer tillatt.",
      "Koblet til en 25%-stilling i et tilknyttet selskap med ansvar for oppfølging av eiendommene på stedet.",
    ],
    forrigeLeieforhold: null,
    signertDato: "2026-09-07",
  ...
  c144: {
    ...
    garantibelop: null,
    saerligeBestemmelser: [
      "Rett til å fremleie deler av lokalet til et datterselskap og andre virksomheter (kun mva-pliktig kontorvirksomhet godkjennes for øvrig fremleie).",
      "Tilgang til sykkelrom/garderobe i «P-bro» mellom Lilleakerveien 4C og 8.",
      "Fremtidig treningsromtilgang i Lilleakerveien 2B ventet (kr 3 000/bruker/år).",
    ],
    forrigeLeieforhold: null,
    signertDato: "2026-08-31",
  ...
  c146: {
    ...
    garantibelop: null,
    saerligeBestemmelser: [
      "Intern relokalisering fra 1. til 5. etasje i samme bygg (Demokunde 29 overtar de gamle lokalene i 1. etasje).",
      "Egen sambruksavtale for fellestjenester i «Lilleakerbyen» signeres separat.",
    ],
    forrigeLeieforhold: null,
  ...
  c149: {
    ...
    garantibelop: null,
    saerligeBestemmelser: [
      "Overtar (transportavtale) forrige leietakers eksisterende leieavtale som den er.",
      "Betinget opsjon på ytterligere 5 år til markedsleie, forutsatt at bygget ikke rives som ledd i «Lilleakerbyen»-utviklingen.",
      "Fortrinnsrett til relokalisering av treningssenter i nytt prosjekt.",
    ],
    forrigeLeieforhold: "Forrige leietaker - transportavtale, ny leietaker trer inn i eksisterende leieavtale fra 01.06.2026.",
...
export type GuaranteeType = "Bankgaranti" | "Depositum" | "Konserngaranti" | "Forsikringsgaranti" | "Annet";

export interface GuaranteeSecured {
  id: string;
  leietaker: string;
  belop: number;
  type: GuaranteeType;
  garantiUtlop: string | null;
  leieforholdUtlop: string | null;
  bygg: string | null;
  lenke: string | null;
  kilde: string;
  usikker?: boolean;
...
export type GuaranteeMissingStatus = "Mangler" | "Forespurt" | "I dialog";

export interface GuaranteeMissing {
  id: string;
  leietaker: string;
  bygg: string | null;
  innflytting: string | null;
  type: "Depositum" | "Garanti" | null;
  belopAvtalt: number | null;
  status: GuaranteeMissingStatus;
  sisteStatusFritekst: string | null;
  kilde: string;
  usikker?: boolean;
  usikkerhetsArsak?: string;
}
...
/**
 * MIDLERTIDIG ANONYMISERT — se merknad over CONTRACTS, og widgets.local.ts sin fyldige kommentar
 * for metodikk (full research-runde 2026-09-26). Leietakernavn byttet til "Demokunde N" -
 * gjenbrukt fra CONTRACTS/RECEIVABLES/EXPIRIES der samme leietaker opptrer der (matchet via delt
 * ID, se build-guarantees.js). Fritekstfelt som nevnte leietakerens eget navn i en annen form
 * eller en kontaktpersons navn er sanert (se FRITEKST_ANON_OVERRIDES i samme script).
 */
export const GUARANTEES_SIST_OPPDATERT = "2026-09-26";
export const HAR_GARANTI: GuaranteeSecured[] = [
  { id: "hg1", leietaker: "Demokunde 35", belop: 7355531, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: null, bygg: null, lenke: null,
    kilde: "Depositum DNB (mottatt 23.09.2021), SharePoint Garantioversikt: dekker totalt leieforhold, 2026-09-22" },
  { id: "hg2", leietaker: "Demokunde 38", belop: 2620000, type: "Bankgaranti",
    garantiUtlop: null, leieforholdUtlop: null, bygg: null, lenke: null,
    kilde: "Nordea bankgaranti 00401-12-0024708, SharePoint: garanti for totalt leieforhold, 2026-09-22" },
  { id: "hg3", leietaker: "Demokunde 282 AS", belop: 1630000, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: null, bygg: "Lilleakerveien 10", lenke: null,
    kilde: "Fazile deposit-tabell (mottatt 28.08.2026), 2026-09-22", usikker: true, usikkerhetsArsak: "Åpen SF-sak 00115601 'Morselskapsgaranti - Leieavtale Lilleakerveien 10' (Avventer_Kunde, 2026-09-18) kan gjelde et annet/tilleggsareal enn denne garantien - avklar før dette telles som fullt dekket." },
  { id: "hg4", leietaker: "Demokunde 44", belop: 1678000, type: "Bankgaranti",
    garantiUtlop: null, leieforholdUtlop: null, bygg: null, lenke: null,
    kilde: "Bankgaranti Danske Bank 23G1530832, SharePoint Garantioversikt, 2026-09-22" },
  { id: "hg5", leietaker: "Demokunde 89", belop: 1610401, type: "Konserngaranti",
    garantiUtlop: null, leieforholdUtlop: null, bygg: null, lenke: null,
    kilde: "Konserngaranti (HS Retail AS), mottatt 10.04.2025, SharePoint Garantioversikt, 2026-09-22" },
  { id: "hg6", leietaker: "Demokunde 102", belop: 1114020, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: null, bygg: null, lenke: null,
    kilde: "Depositum DNB 1506 99 65544, mottatt 03.11.2023, SharePoint Garantioversikt, 2026-09-22" },
  { id: "hg7", leietaker: "Demokunde 156", belop: 755000, type: "Bankgaranti",
    garantiUtlop: null, leieforholdUtlop: null, bygg: null, lenke: null,
    kilde: "Bankgaranti Nordea 00222-02-3034754, mottatt 25.03.2022, SharePoint Garantioversikt, 2026-09-22" },
  { id: "hg8", leietaker: "Demokunde 50", belop: 592900, type: "Forsikringsgaranti",
    garantiUtlop: null, leieforholdUtlop: null, bygg: null, lenke: null,
    kilde: "Forsikringsgaranti Hiscox, mottatt 15.07.2023, SharePoint Garantioversikt, 2026-09-22" },
  { id: "hg9", leietaker: "Demokunde 202", belop: 40000, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2026-12-31", bygg: "Lilleakerveien 14", lenke: null,
    kilde: "Depositum Danske Bank 8101.06.63482, mottatt 09.10.2021, SharePoint Garantioversikt, 2026-09-22" },
  { id: "hg10", leietaker: "Demokunde 579 AS", belop: 1130543, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2029-06-30", bygg: "Lilleakerveien 8", lenke: null,
    kilde: "Depositum DNB 1506.81.29416, mottatt 13.01.2025, SharePoint Garantioversikt, 2026-09-22" },
  { id: "hg11", leietaker: "Demokunde 580 AS", belop: 3890911, type: "Bankgaranti",
    garantiUtlop: null, leieforholdUtlop: "2028-01-31", bygg: "Lilleakerveien 2A", lenke: null,
    kilde: "Bankgaranti - registrert på et tilknyttet selskap (Morten bekreftet 2026-09-22: samme juridiske enhet), SharePoint Garantioversikt" },
  { id: "hg12", leietaker: "Demokunde 581 AS", belop: 41822449, type: "Bankgaranti",
    garantiUtlop: "2034-07-01", leieforholdUtlop: "2034-03-31", bygg: "Strandveien 4-8", lenke: null,
    kilde: "Bankgaranti Strandveien 4-8, 6 mnd leie inkl fk mva - registrert på et tilknyttet selskap (Morten bekreftet 2026-09-22: samme juridiske enhet), SharePoint Garantioversikt" },
  { id: "hg13", leietaker: "Demokunde 91", belop: 64918, type: "Depositum",
    garantiUtlop: "2028-12-31", leieforholdUtlop: null, bygg: "Lilleakerveien 2C/D", lenke: null,
    kilde: "Fazile deposit-tabell, 2026-09-22; matcher Fenistra 'Under arbeid'-rad fra 2026-02-27 som nå er løst" },
  { id: "hg14", leietaker: "Demokunde 582 AS", belop: 377000, type: "Bankgaranti",
    garantiUtlop: "2027-01-31", leieforholdUtlop: "2026-10-31", bygg: "Lilleakerveien 2C/D", lenke: null,
    kilde: "Bankgaranti DNB 00935-02-2075111, mottatt 07.02.2023, SharePoint Garantioversikt, 2026-09-22" },
  { id: "hg15", leietaker: "Demokunde 205", belop: 380929, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: null, bygg: null, lenke: null,
    kilde: "Fazile deposit-tabell, 2026-09-22" },
  { id: "hg16", leietaker: "Demokunde 583 AS", belop: 261646, type: "Depositum",
    garantiUtlop: "2027-11-30", leieforholdUtlop: "2027-11-30", bygg: "Vollsveien 13-19", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 26.11.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg17", leietaker: "Demokunde 36", belop: 1512000, type: "Konserngaranti",
    garantiUtlop: "2025-04-01", leieforholdUtlop: "2028-03-31", bygg: "Lilleakerveien 14", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg18", leietaker: "Demokunde 584 AS", belop: 6942700, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2031-11-30", bygg: "Lilleakerveien  2B", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 24.04.2025", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg19", leietaker: "Demokunde 92", belop: 1455525, type: "Bankgaranti",
    garantiUtlop: "2028-12-31", leieforholdUtlop: "2028-12-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 21.09.2023", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg20", leietaker: "Demokunde 283 AS", belop: 245000, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2030-08-31", bygg: "Lilleakerveien  8", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 26.08.2025", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg21", leietaker: "Demokunde 169", belop: 801250, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2035-12-31", bygg: "Lilleakerveien  8", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 28.05.2025", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg22", leietaker: "Demokunde 58", belop: 2768000, type: "Bankgaranti",
    garantiUtlop: "2027-03-31", leieforholdUtlop: "2026-12-31", bygg: "Lilleakerveien  2C/D", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 10.05.2022", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg23", leietaker: "Demokunde 7", belop: 33000, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2028-03-31", bygg: "Lilleakerveien 19", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg24", leietaker: "Demokunde 125", belop: 995775, type: "Bankgaranti",
    garantiUtlop: "2030-11-30", leieforholdUtlop: "2030-08-31", bygg: "Lilleakerveien  6", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 24.09.2025", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg25", leietaker: "Demokunde 585 AS", belop: 90512, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2028-07-31", bygg: "Lilleakerveien  2E", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 04.08.2025", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg26", leietaker: "Demokunde 149", belop: 450893, type: "Bankgaranti",
    garantiUtlop: "2030-05-31", leieforholdUtlop: "2030-02-28", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 11.04.2025", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg27", leietaker: "Demokunde 21", belop: 858367, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2028-03-31", bygg: "Lilleakerveien  8", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 26.02.2020", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg28", leietaker: "Demokunde 586", belop: 5738358, type: "Konserngaranti",
    garantiUtlop: "2025-02-28", leieforholdUtlop: "2029-12-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg29", leietaker: "Demokunde 131", belop: 600000, type: "Bankgaranti",
    garantiUtlop: null, leieforholdUtlop: "2026-12-31", bygg: "Lilleakerveien 30", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 23.01.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg30", leietaker: "Demokunde 16", belop: 3151750, type: "Forsikringsgaranti",
    garantiUtlop: "2029-02-10", leieforholdUtlop: "2031-08-31", bygg: "Vollsveien 13-19", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 31.10.2023", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg31", leietaker: "Demokunde 12", belop: 16800000, type: "Bankgaranti",
    garantiUtlop: null, leieforholdUtlop: "2030-02-28", bygg: "Lilleakerveien  4C-F", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 06.11.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg32", leietaker: "Demokunde 587 AS", belop: 999000, type: "Bankgaranti",
    garantiUtlop: null, leieforholdUtlop: "2026-10-26", bygg: "Lilleakerveien  8", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg33", leietaker: "Demokunde 588 AS", belop: 246804, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2027-03-31", bygg: "Lilleakerveien 31", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 03.01.2025", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg34", leietaker: "Demokunde 589 AS", belop: 49069, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2027-03-31", bygg: "Lilleakerveien  2E", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 15.03.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg35", leietaker: "Demokunde 243 AS", belop: 30000, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2029-12-31", bygg: "Lilleakerveien  8", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 15.01.2025", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg36", leietaker: "Demokunde 590 AS", belop: 571422, type: "Bankgaranti",
    garantiUtlop: "2030-03-31", leieforholdUtlop: "2029-12-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg37", leietaker: "Demokunde 277 AS", belop: 1000000, type: "Annet",
    garantiUtlop: "2025-05-31", leieforholdUtlop: "2030-12-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 26.11.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg38", leietaker: "Demokunde 95", belop: 680000, type: "Bankgaranti",
    garantiUtlop: "2031-03-31", leieforholdUtlop: "2030-12-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 12.12.2025", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg39", leietaker: "Demokunde 591", belop: 980679, type: "Konserngaranti",
    garantiUtlop: "2029-03-31", leieforholdUtlop: "2028-12-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 19.02.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg40", leietaker: "Demokunde 143", belop: 762300, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2029-01-31", bygg: "Vollsveien 13-19", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 13.12.2023", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg41", leietaker: "Demokunde 592 AS", belop: 663000, type: "Bankgaranti",
    garantiUtlop: "2030-06-30", leieforholdUtlop: "2030-03-31", bygg: "Lilleakerveien 31", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 26.03.2025", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg42", leietaker: "Demokunde 593 AS", belop: 14667000, type: "Bankgaranti",
    garantiUtlop: "2031-03-31", leieforholdUtlop: "2030-12-31", bygg: "Lilleakerveien  8", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 20.12.2021", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg43", leietaker: "Demokunde 142", belop: 910000, type: "Bankgaranti",
    garantiUtlop: "2029-11-14", leieforholdUtlop: "2039-02-15", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 29.01.2025", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg44", leietaker: "Demokunde 594 AS", belop: 36100, type: "Depositum",
    garantiUtlop: "2026-12-31", leieforholdUtlop: "2026-12-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg45", leietaker: "Demokunde 207", belop: 160000, type: "Depositum",
    garantiUtlop: "2025-03-31", leieforholdUtlop: "2028-03-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 14.03.2022", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg46", leietaker: "Demokunde 595 AS", belop: 301250, type: "Konserngaranti",
    garantiUtlop: "2028-10-31", leieforholdUtlop: "2028-08-31", bygg: "Lilleakerveien 29", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg47", leietaker: "Demokunde 174", belop: 576482, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2028-03-31", bygg: "Lilleakerveien  8", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg48", leietaker: "Demokunde 193", belop: 221995, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2029-06-30", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 12.08.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg49", leietaker: "Demokunde 596 AS", belop: 64230, type: "Annet",
    garantiUtlop: null, leieforholdUtlop: "2026-12-31", bygg: "Lilleakerveien  2E", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 11.01.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg50", leietaker: "Demokunde 597 AS", belop: 326282, type: "Depositum",
    garantiUtlop: "2028-03-31", leieforholdUtlop: "2027-12-31", bygg: "Lilleakerveien 31", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 29.08.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg51", leietaker: "Demokunde 73", belop: 2848320, type: "Bankgaranti",
    garantiUtlop: "2029-02-28", leieforholdUtlop: "2028-11-30", bygg: "Lilleakerveien  2B", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 19.10.2023", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg52", leietaker: "Demokunde 598 AS", belop: 136442, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2026-01-31", bygg: "Lilleakerveien 31", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2025-10-24, mottatt 23.05.2023", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg53", leietaker: "Demokunde 145", belop: 273450, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2029-09-30", bygg: "Lilleakerveien 14", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 26.09.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg54", leietaker: "Demokunde 599", belop: 28933, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2027-04-30", bygg: "Lilleakerveien  2B", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 21.04.2022", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg55", leietaker: "Demokunde 176", belop: 563450, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2026-07-15", bygg: "Lilleakerveien  2B", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 08.01.2021", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg56", leietaker: "Demokunde 51", belop: 4006943, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2034-01-31", bygg: "Lilleakerveien  8", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg57", leietaker: "Demokunde 600", belop: 657929, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2028-08-31", bygg: "Lilleakerveien  2B", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg58", leietaker: "Demokunde 134", belop: 680000, type: "Depositum",
    garantiUtlop: "2027-02-28", leieforholdUtlop: "2027-08-31", bygg: "Lilleakerveien  2B", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 01.09.2022", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg59", leietaker: "Demokunde 241 A/S", belop: 1668155, type: "Bankgaranti",
    garantiUtlop: "2028-12-31", leieforholdUtlop: "2028-09-30", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 08.01.2025", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg60", leietaker: "Demokunde 34", belop: 6607258, type: "Konserngaranti",
    garantiUtlop: "2024-10-14", leieforholdUtlop: "2030-12-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 10.09.2014", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg61", leietaker: "Demokunde 91", belop: 527000, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2029-12-31", bygg: "Lilleakerveien  2C/D", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 26.02.2025", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg62", leietaker: "Demokunde 601 AS", belop: 485000, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2027-10-31", bygg: "Lilleakerveien  4A", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg63", leietaker: "Demokunde 137", belop: 181754, type: "Depositum",
    garantiUtlop: "2025-03-31", leieforholdUtlop: "2026-03-31", bygg: "Vollsveien 13-19", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 17.02.2022", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg64", leietaker: "Demokunde 141", belop: 768105, type: "Bankgaranti",
    garantiUtlop: "2027-04-01", leieforholdUtlop: "2027-02-01", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg65", leietaker: "Demokunde 602 AS", belop: 941625, type: "Bankgaranti",
    garantiUtlop: "2028-12-31", leieforholdUtlop: "2028-09-30", bygg: "Vollsveien 13-19", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 27.09.2023", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg66", leietaker: "Demokunde 129", belop: 967864, type: "Bankgaranti",
    garantiUtlop: "2027-12-31", leieforholdUtlop: "2027-12-31", bygg: "Lilleakerveien  6", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 11.02.2025", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg67", leietaker: "Demokunde 603", belop: 168250, type: "Depositum",
    garantiUtlop: "2026-09-30", leieforholdUtlop: "2026-09-30", bygg: "Lilleakerveien  8", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 01.07.2022", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg68", leietaker: "Demokunde 293 AS", belop: 114497, type: "Depositum",
    garantiUtlop: "2025-10-31", leieforholdUtlop: "2026-03-31", bygg: "Vollsveien 13-19", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 28.10.2020", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg69", leietaker: "Demokunde 140", belop: 1631706, type: "Depositum",
    garantiUtlop: "2025-05-31", leieforholdUtlop: "2028-03-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 27.03.2020", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg70", leietaker: "Demokunde 139", belop: 860076, type: "Bankgaranti",
    garantiUtlop: "2029-11-30", leieforholdUtlop: "2029-08-31", bygg: "Lilleakerveien  6", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 17.12.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg71", leietaker: "Demokunde 604 AS", belop: 310615, type: "Annet",
    garantiUtlop: null, leieforholdUtlop: "2027-08-31", bygg: "Lilleakerveien  4A", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg72", leietaker: "Demokunde 60", belop: 2518486, type: "Forsikringsgaranti",
    garantiUtlop: "2029-07-30", leieforholdUtlop: "2031-02-28", bygg: "Lilleakerveien  8", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 30.01.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg73", leietaker: "Demokunde 88", belop: 1570000, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2027-07-31", bygg: "Lilleakerveien  2C/D", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 10.08.2022", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg74", leietaker: "Demokunde 171", belop: 415000, type: "Konserngaranti",
    garantiUtlop: null, leieforholdUtlop: "2028-08-31", bygg: "Lilleakerveien 31", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 30.06.2018", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg75", leietaker: "Demokunde 7", belop: 924334, type: "Bankgaranti",
    garantiUtlop: "2028-08-01", leieforholdUtlop: "2028-05-01", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 25.03.2023", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg76", leietaker: "Demokunde 605 AS", belop: 1270000, type: "Bankgaranti",
    garantiUtlop: "2026-12-31", leieforholdUtlop: "2026-12-31", bygg: "Vollsveien 13-19", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 25.11.2021", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg77", leietaker: "Demokunde 606 AS", belop: 269875, type: "Bankgaranti",
    garantiUtlop: "2028-12-30", leieforholdUtlop: "2028-09-30", bygg: "Vollsveien 13-19", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 18.09.2023", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg78", leietaker: "Demokunde 607 AS", belop: 131000, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2028-12-31", bygg: "Lilleakerveien 31", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 24.04.2023", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg79", leietaker: "Demokunde 189", belop: 69975, type: "Annet",
    garantiUtlop: null, leieforholdUtlop: "2026-12-31", bygg: "Lilleakerveien  2E", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 27.02.2023", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg80", leietaker: "Demokunde 69", belop: 2261930, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2029-08-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 09.10.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg81", leietaker: "Demokunde 184", belop: 217800, type: "Forsikringsgaranti",
    garantiUtlop: "2028-03-31", leieforholdUtlop: "2027-12-31", bygg: "Lilleakerveien  4A", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg82", leietaker: "Demokunde 175", belop: 576972, type: "Bankgaranti",
    garantiUtlop: "2028-11-30", leieforholdUtlop: "2028-08-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 04.09.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg83", leietaker: "Demokunde 608 AS", belop: 543329, type: "Depositum",
    garantiUtlop: "2026-10-31", leieforholdUtlop: "2026-10-31", bygg: "Lilleakerveien  8", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 03.11.2021", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg84", leietaker: "Demokunde 260 AS", belop: 2848425, type: "Depositum",
    garantiUtlop: "2026-03-31", leieforholdUtlop: "2026-03-31", bygg: "Lilleakerveien 14", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg85", leietaker: "Demokunde 609 AS", belop: 198281, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2028-12-31", bygg: "Strandveien  4-8", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 02.02.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg86", leietaker: "Demokunde 110", belop: 1000000, type: "Bankgaranti",
    garantiUtlop: "2027-07-30", leieforholdUtlop: "2027-04-30", bygg: "Lilleakerveien 14", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 05.04.2022", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg87", leietaker: "Demokunde 64", belop: 1841928, type: "Depositum",
    garantiUtlop: "2029-10-31", leieforholdUtlop: "2029-08-31", bygg: "Vollsveien 13-19", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 18.02.2019", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg88", leietaker: "Demokunde 101", belop: 1230979, type: "Depositum",
    garantiUtlop: "2026-12-31", leieforholdUtlop: "2027-12-31", bygg: "Vollsveien 13-19", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 04.04.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg89", leietaker: "Demokunde 33", belop: 1753707, type: "Bankgaranti",
    garantiUtlop: "2029-03-31", leieforholdUtlop: "2028-12-31", bygg: "Vollsveien 13-19", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 29.01.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg90", leietaker: "Demokunde 199", belop: 4250000, type: "Bankgaranti",
    garantiUtlop: "2029-03-31", leieforholdUtlop: "2029-03-31", bygg: "Lilleakerveien  2A", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 11.03.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg91", leietaker: "Demokunde 610 AS", belop: 239250, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2026-03-31", bygg: "Lilleakerveien  6", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 01.07.2017", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg92", leietaker: "Demokunde 153", belop: 745531, type: "Bankgaranti",
    garantiUtlop: "2030-03-31", leieforholdUtlop: "2029-12-31", bygg: "Lilleakerveien  4C-F", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 12.11.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg93", leietaker: "Demokunde 84", belop: 1571121, type: "Bankgaranti",
    garantiUtlop: "2028-07-31", leieforholdUtlop: "2028-04-30", bygg: "Lilleakerveien  6", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 22.05.2023", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg94", leietaker: "Demokunde 24", belop: 1563693, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2029-04-03", bygg: "Lilleakerveien  6", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 26.01.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg95", leietaker: "Demokunde 611 AS", belop: 507163, type: "Depositum",
    garantiUtlop: "2028-12-31", leieforholdUtlop: "2028-12-31", bygg: "Lilleakerveien  4A", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 31.12.2025", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg96", leietaker: "Demokunde 65", belop: 2677998, type: "Depositum",
    garantiUtlop: "2029-01-20", leieforholdUtlop: "2029-01-20", bygg: "Lilleakerveien  8", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 06.10.2025", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg97", leietaker: "Demokunde 612 AS", belop: 238938, type: "Annet",
    garantiUtlop: "2028-01-31", leieforholdUtlop: "2027-10-31", bygg: "Vollsveien 13-19", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg98", leietaker: "Demokunde 49", belop: 4815000, type: "Bankgaranti",
    garantiUtlop: "2029-04-30", leieforholdUtlop: "2029-01-31", bygg: "Lilleakerveien  2A", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 13.01.2022", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg99", leietaker: "Demokunde 613 AS", belop: 3076832, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2026-02-28", bygg: "Lilleakerveien  2C/D", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 29.05.2020", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg100", leietaker: "Demokunde 94", belop: 1072500, type: "Konserngaranti",
    garantiUtlop: null, leieforholdUtlop: "2027-08-31", bygg: "Lilleakerveien  4A", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 06.05.2022", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg101", leietaker: "Demokunde 74", belop: 1849959, type: "Bankgaranti",
    garantiUtlop: "2030-04-01", leieforholdUtlop: "2029-12-31", bygg: "Lilleakerveien  2B", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 31.03.2023", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg102", leietaker: "Demokunde 286 AS", belop: 3419341, type: "Konserngaranti",
    garantiUtlop: "2025-03-31", leieforholdUtlop: "2028-12-31", bygg: "Lilleakerveien 14", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 05.03.2020", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg103", leietaker: "Demokunde 614 AS", belop: 225000, type: "Depositum",
    garantiUtlop: "2026-02-28", leieforholdUtlop: "2031-02-28", bygg: "Vollsveien 13-19", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 04.02.2021", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg104", leietaker: "Demokunde 81", belop: 1418260, type: "Forsikringsgaranti",
    garantiUtlop: "2026-03-31", leieforholdUtlop: "2030-12-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 15.10.2020", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg105", leietaker: "Demokunde 175", belop: 1470000, type: "Depositum",
    garantiUtlop: "2026-05-31", leieforholdUtlop: "2026-05-31", bygg: "Lilleakerveien 10", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 22.03.2019", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg106", leietaker: "Demokunde 615 AS", belop: 410000, type: "Bankgaranti",
    garantiUtlop: "2029-08-30", leieforholdUtlop: "2029-06-30", bygg: "Vollsveien 13-19", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 19.09.2022", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg107", leietaker: "Demokunde 616 AS", belop: 1074813, type: "Bankgaranti",
    garantiUtlop: "2029-04-30", leieforholdUtlop: "2029-04-30", bygg: "Lilleakerveien 10", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 04.07.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg108", leietaker: "Demokunde 617 AS", belop: 696085, type: "Bankgaranti",
    garantiUtlop: "2030-02-28", leieforholdUtlop: "2029-12-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2025-10-24, mottatt 12.02.2020", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg109", leietaker: "Demokunde 155", belop: 3530753, type: "Konserngaranti",
    garantiUtlop: null, leieforholdUtlop: "2032-08-31", bygg: "Lilleakerveien  2A", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg110", leietaker: "Demokunde 124", belop: 873740, type: "Forsikringsgaranti",
    garantiUtlop: "2024-04-30", leieforholdUtlop: "2029-01-31", bygg: "Vollsveien 13-19", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 07.03.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg111", leietaker: "Demokunde 198", belop: 447000, type: "Depositum",
    garantiUtlop: "2025-09-30", leieforholdUtlop: "2026-05-31", bygg: "Lilleakerveien  8", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 16.04.2019", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg112", leietaker: "Demokunde 233 AS", belop: 475000, type: "Depositum",
    garantiUtlop: "2026-05-31", leieforholdUtlop: "2026-05-31", bygg: "Vollsveien 13-19", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 21.05.2021", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg113", leietaker: "Demokunde 54", belop: 617019, type: "Bankgaranti",
    garantiUtlop: "2034-03-31", leieforholdUtlop: "2033-12-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 21.01.2026", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg114", leietaker: "Demokunde 160", belop: 414696, type: "Bankgaranti",
    garantiUtlop: "2027-04-30", leieforholdUtlop: "2027-02-01", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 20.01.2023", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg115", leietaker: "Demokunde 618 AS", belop: 856395, type: "Forsikringsgaranti",
    garantiUtlop: "2026-03-31", leieforholdUtlop: "2030-12-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2025-10-24, mottatt 11.08.2021", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg116", leietaker: "Demokunde 619 AS", belop: 62440, type: "Depositum",
    garantiUtlop: "2024-12-31", leieforholdUtlop: "2027-12-31", bygg: "Lilleakerveien  2E", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg117", leietaker: "Demokunde 620 AS", belop: 98231, type: "Depositum",
    garantiUtlop: "2029-12-31", leieforholdUtlop: "2029-12-31", bygg: "Lilleakerveien 31", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 15.11.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg118", leietaker: "Demokunde 109", belop: 1361000, type: "Bankgaranti",
    garantiUtlop: "2027-02-28", leieforholdUtlop: "2026-11-30", bygg: "Lilleakerveien  8", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 09.06.2021", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg119", leietaker: "Demokunde 219", belop: 178125, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2028-03-31", bygg: "Lilleakerveien 30", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg120", leietaker: "Demokunde 621 AS", belop: 293353, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2027-06-30", bygg: "Strandveien  4-8", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 28.06.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg121", leietaker: "Demokunde 622", belop: 48000, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2027-05-31", bygg: "Lilleakerveien 26", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 24.05.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg122", leietaker: "Demokunde 623", belop: 49200, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2027-02-14", bygg: "Gamle Drammensvei 10", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 13.01.2025", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg123", leietaker: "Demokunde 624", belop: 39900, type: "Annet",
    garantiUtlop: null, leieforholdUtlop: "2026-06-30", bygg: "Lilleakerveien 26", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 11.05.2023", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg124", leietaker: "Demokunde 625", belop: 48000, type: "Depositum",
    garantiUtlop: "2027-05-31", leieforholdUtlop: "2027-04-30", bygg: "Lilleakerveien 26", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 30.04.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg125", leietaker: "Demokunde 626 AS", belop: 130000, type: "Annet",
    garantiUtlop: null, leieforholdUtlop: "2027-12-31", bygg: "Lilleakerveien 31", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg126", leietaker: "Demokunde 198", belop: 449474, type: "Bankgaranti",
    garantiUtlop: "2032-05-28", leieforholdUtlop: "2032-02-28", bygg: "Vollsveien 13D", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 07.02.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg127", leietaker: "Demokunde 627 AS", belop: 130234, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2028-07-31", bygg: "Lilleakerveien  4A", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 07.07.2025", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg128", leietaker: "Demokunde 136", belop: 716000, type: "Bankgaranti",
    garantiUtlop: "2031-05-01", leieforholdUtlop: "2031-02-01", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 23.08.2021", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg129", leietaker: "Demokunde 154", belop: 685461, type: "Bankgaranti",
    garantiUtlop: "2027-08-31", leieforholdUtlop: "2027-02-28", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 06.02.2023", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg130", leietaker: "Demokunde 179", belop: 396572, type: "Konserngaranti",
    garantiUtlop: "2028-04-30", leieforholdUtlop: "2028-01-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 01.12.2022", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg131", leietaker: "Demokunde 122", belop: 1171794, type: "Bankgaranti",
    garantiUtlop: "2029-10-31", leieforholdUtlop: "2029-07-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 01.08.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg132", leietaker: "Demokunde 628", belop: 51890, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2030-05-11", bygg: "Lilleakerveien 31", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 27.05.2025", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg133", leietaker: "Demokunde 213", belop: 280875, type: "Depositum",
    garantiUtlop: "2030-12-31", leieforholdUtlop: "2030-12-31", bygg: "Vollsveien 13-19", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 14.10.2020", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg134", leietaker: "Demokunde 144", belop: 398772, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2027-02-28", bygg: "Lilleakerveien 14", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 16.06.2023", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg135", leietaker: "Demokunde 629 AS", belop: 274579, type: "Bankgaranti",
    garantiUtlop: "2027-03-31", leieforholdUtlop: "2026-12-31", bygg: "Vollsveien 13-19", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 17.06.2025", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg136", leietaker: "Demokunde 630 AS", belop: 385943, type: "Bankgaranti",
    garantiUtlop: "2031-10-31", leieforholdUtlop: "2031-07-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 25.08.2022", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg137", leietaker: "Demokunde 631", belop: 46958, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2029-12-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg138", leietaker: "Demokunde 632", belop: 30000, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2027-04-30", bygg: "Lilleakerveien 19", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 23.04.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg139", leietaker: "Demokunde 633 AS", belop: 5282550, type: "Bankgaranti",
    garantiUtlop: "2030-02-28", leieforholdUtlop: "2029-11-30", bygg: "Vollsveien 13-19", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 16.05.2023", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg140", leietaker: "Demokunde 634 AS", belop: 280119, type: "Annet",
    garantiUtlop: "2026-10-31", leieforholdUtlop: "2026-10-31", bygg: "Lilleakerveien  8", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 09.04.2025", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg141", leietaker: "Demokunde 635 AS", belop: 99000, type: "Depositum",
    garantiUtlop: "2025-04-30", leieforholdUtlop: "2026-02-28", bygg: "Vollsveien 13-19", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 20.02.2019", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg142", leietaker: "Demokunde 636", belop: 48000, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2027-06-30", bygg: "Lilleakerveien 26", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 01.07.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg143", leietaker: "Demokunde 637", belop: 52500, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2028-08-12", bygg: "Gamle Drammensvei 10", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 14.08.2025", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg144", leietaker: "Demokunde 199", belop: 215000, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2028-06-30", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 07.10.2025", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg145", leietaker: "Demokunde 638 AS", belop: 420013, type: "Bankgaranti",
    garantiUtlop: "2028-11-30", leieforholdUtlop: "2028-08-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 03.10.2025", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg146", leietaker: "Demokunde 111", belop: 9999999, type: "Konserngaranti",
    garantiUtlop: null, leieforholdUtlop: "2029-09-30", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg147", leietaker: "Demokunde 280", belop: 82078, type: "Depositum",
    garantiUtlop: "2026-08-31", leieforholdUtlop: "2026-08-31", bygg: "Vollsveien 13-19", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 17.08.2021", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg148", leietaker: "Demokunde 639", belop: 43500, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2026-08-31", bygg: "Gamle Drammensvei 10", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 06.09.2023", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg149", leietaker: "Demokunde 640 AS", belop: 141831, type: "Depositum",
    garantiUtlop: "2030-03-31", leieforholdUtlop: "2029-12-31", bygg: "Strandveien  4-8", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg150", leietaker: "Demokunde 641", belop: 39000, type: "Annet",
    garantiUtlop: "2023-02-28", leieforholdUtlop: "2026-06-30", bygg: "Gamle Drammensvei 10", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 03.06.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg151", leietaker: "Demokunde 642", belop: 45000, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2028-10-31", bygg: "Lilleakerveien 26", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 31.10.2022", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg152", leietaker: "Demokunde 643", belop: 2556415, type: "Konserngaranti",
    garantiUtlop: "2024-02-28", leieforholdUtlop: "2030-12-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg153", leietaker: "Demokunde 105", belop: 10000000, type: "Konserngaranti",
    garantiUtlop: "2026-12-31", leieforholdUtlop: "2026-12-31", bygg: "Lilleakerveien  8", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 24.09.2021", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg154", leietaker: "Demokunde 63", belop: 2838134, type: "Bankgaranti",
    garantiUtlop: "2032-03-31", leieforholdUtlop: "2031-12-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 27.08.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg155", leietaker: "Demokunde 304 AS", belop: 434125, type: "Konserngaranti",
    garantiUtlop: "2028-03-31", leieforholdUtlop: "2028-01-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 06.01.2023", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg156", leietaker: "Demokunde 147", belop: 927583, type: "Bankgaranti",
    garantiUtlop: "2030-01-31", leieforholdUtlop: "2030-01-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 24.03.2025", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg157", leietaker: "Demokunde 83", belop: 2818774, type: "Konserngaranti",
    garantiUtlop: "2025-12-31", leieforholdUtlop: "2030-12-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg158", leietaker: "Demokunde 644 AS", belop: 60000, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2029-03-31", bygg: "Lilleakerveien 31", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg159", leietaker: "Demokunde 645 AS", belop: 96000, type: "Depositum",
    garantiUtlop: "2026-12-31", leieforholdUtlop: "2026-12-31", bygg: "Vollsveien 13-19", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 16.12.2021", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg160", leietaker: "Demokunde 646 AS", belop: 500000, type: "Annet",
    garantiUtlop: null, leieforholdUtlop: "2028-11-30", bygg: "Lilleakerveien 10", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 27.11.2023", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg161", leietaker: "Demokunde 206", belop: 320000, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2030-03-15", bygg: "Lilleakerveien 31", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg162", leietaker: "Demokunde 647 AS", belop: 280000, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2029-09-30", bygg: "Lilleakerveien 31", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg163", leietaker: "Demokunde 648 AS", belop: 510000, type: "Depositum",
    garantiUtlop: "2030-01-31", leieforholdUtlop: "2030-01-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 05.03.2020", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg164", leietaker: "Demokunde 157", belop: 385000, type: "Annet",
    garantiUtlop: "2031-04-24", leieforholdUtlop: "2031-01-30", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 07.10.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg165", leietaker: "Demokunde 649", belop: 10400, type: "Annet",
    garantiUtlop: "2027-12-31", leieforholdUtlop: "2027-12-31", bygg: "Lilleakerveien 19", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 19.12.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg166", leietaker: "Demokunde 650 AS", belop: 96225, type: "Depositum",
    garantiUtlop: "2026-04-30", leieforholdUtlop: "2026-04-30", bygg: "Vollsveien 13-19", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg167", leietaker: "Demokunde 651 AS", belop: 116828, type: "Bankgaranti",
    garantiUtlop: "2024-09-30", leieforholdUtlop: "2027-12-31", bygg: "Lilleakerveien  4A", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 16.02.2022", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg168", leietaker: "Demokunde 652 AS", belop: 11892, type: "Depositum",
    garantiUtlop: "2027-12-31", leieforholdUtlop: "2027-12-31", bygg: "Lilleakerveien 31", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg169", leietaker: "Demokunde 653 AS", belop: 399448, type: "Bankgaranti",
    garantiUtlop: "2025-11-30", leieforholdUtlop: "2025-12-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2025-10-24, mottatt 02.11.2020", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg170", leietaker: "Demokunde 654", belop: 47550, type: "Depositum",
    garantiUtlop: "2024-05-15", leieforholdUtlop: "2028-05-14", bygg: "Lilleakerveien 26", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 01.05.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg171", leietaker: "Demokunde 655", belop: 48000, type: "Depositum",
    garantiUtlop: null, leieforholdUtlop: "2027-06-30", bygg: "Lilleakerveien 26", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 26.06.2024", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg172", leietaker: "Demokunde 256 AS", belop: 300000, type: "Konserngaranti",
    garantiUtlop: "2026-05-31", leieforholdUtlop: "2028-03-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 06.02.2025", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg173", leietaker: "Demokunde 38", belop: 361245, type: "Bankgaranti",
    garantiUtlop: "2026-03-31", leieforholdUtlop: "2028-12-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 28.09.2022", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg174", leietaker: "Demokunde 133", belop: 693524, type: "Konserngaranti",
    garantiUtlop: "2025-09-30", leieforholdUtlop: "2030-08-30", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 29.06.2020", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg175", leietaker: "Demokunde 656 AS", belop: 93000, type: "Bankgaranti",
    garantiUtlop: "2025-04-30", leieforholdUtlop: "2028-02-29", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 21.02.2020", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg176", leietaker: "Demokunde 177", belop: 132998, type: "Bankgaranti",
    garantiUtlop: "2024-08-30", leieforholdUtlop: "2029-02-28", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 12.07.2019", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg177", leietaker: "Demokunde 258 AS", belop: 1138703, type: "Bankgaranti",
    garantiUtlop: "2030-12-31", leieforholdUtlop: "2030-12-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 16.12.2025", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg178", leietaker: "Demokunde 127", belop: 497349, type: "Bankgaranti",
    garantiUtlop: "2027-07-31", leieforholdUtlop: "2030-08-31", bygg: "Lilleakerveien  2F", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 25.04.2024", usikker: true, usikkerhetsArsak: "Samme garanti dukket opp under to ulike navn i to Fenistra-snapshot (to ulike selskapsnavn i de to uttrekkene) - identisk beløp/bygg/dato bekrefter at det er én og samme garanti. Uklart hvilket navn som er korrekt juridisk navn i dag - sjekk ved neste oppdatering." },
  { id: "hg179", leietaker: "Demokunde 657 AS", belop: 5856628, type: "Annet",
    garantiUtlop: null, leieforholdUtlop: "2027-12-31", bygg: "Lilleakerveien  4A", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg180", leietaker: "Demokunde 191", belop: 466850, type: "Depositum",
    garantiUtlop: "2030-12-31", leieforholdUtlop: "2030-12-31", bygg: "Lilleakerveien  2B", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 03.11.2025", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
  { id: "hg181", leietaker: "Demokunde 203", belop: 553916, type: "Bankgaranti",
    garantiUtlop: "2025-05-31", leieforholdUtlop: "2030-03-31", bygg: "CC vest", lenke: null,
    kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27, mottatt 11.05.2020", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering), ikke kryssjekket mot noe friskere i denne runden." },
];
export const MANGLER_GARANTI: GuaranteeMissing[] = [
  { id: "mg1", leietaker: "Demokunde 221 AS", bygg: "Vollsveien 17", innflytting: null,
    type: "Garanti", belopAvtalt: null, status: "I dialog",
    sisteStatusFritekst: "SF-sak 00112758 'SV: Garanti for kontrakt 17B - Origon', Avventer_Kunde, sist endret 2026-09-14. Åpen Asana-subtask 'Koordinere (Origon) bankgaranti eller depositum', frist 2026-09-29, sist endret 2026-09-25.", kilde: "Asana (live subtask) + Salesforce Case 00112758, begge 2026-09" },
  { id: "mg2", leietaker: "Demokunde 658 AS", bygg: "CC vest (Rema 1000)", innflytting: null,
    type: null, belopAvtalt: null, status: "Mangler",
    sisteStatusFritekst: "Ny onboarding, ikke startet. Åpen Asana-subtask, frist 2026-09-28, opprettet 2026-09-25 - ikke i noen tidligere kilde, helt fersk.", kilde: "Asana (live subtask), 2026-09-25", usikker: true, usikkerhetsArsak: "Ingen bekreftelse på at leieforholdet faktisk har et garanti-/depositumskrav i kontrakten - kun en gammel/tynn notis uten beløp, type eller dato å bygge på. Kryssjekk kontraktsvilkårene før dette regnes som en reell oppfølgingssak (Morten 2026-09-26: «mangler garanti» skal kun gjelde der kontrakten krever det)." },
  { id: "mg3", leietaker: "Demokunde 659 AS", bygg: "CC vest", innflytting: "2023-11-01",
    type: null, belopAvtalt: 282783, status: "I dialog",
    sisteStatusFritekst: "SF-sak 00115782 'Garanti i forbindelse med leieforlengelse', status Iverksettes, sist endret 2026-09-24.", kilde: "Salesforce Case 00115782 (2026-09-24) + Fenistra 2026-02-27 (beløp)" },
  { id: "mg4", leietaker: "Demokunde 660 AS", bygg: "Lilleakerveien 10 og 14", innflytting: null,
    type: "Garanti", belopAvtalt: null, status: "I dialog",
    sisteStatusFritekst: "SF-sak 00113092 'Konserngaranti i forbindelse med forlengelse av leieforhold', Avventer_Kunde, sist endret 2026-08-10. Forrige konserngaranti (mottatt 2021) utløp 30.06.2026.", kilde: "Salesforce Case 00113092, 2026-08-10" },
  { id: "mg5", leietaker: "Demokunde 103", bygg: "Lilleakerveien 31", innflytting: "2024-01-01",
    type: "Depositum", belopAvtalt: null, status: "Mangler",
    sisteStatusFritekst: null, kilde: "Fenistra 2026-02-27 'Ikke mottatt' + egen sjekk 2026-09-22 fant heller ingen garanti registrert (samme konklusjon, 7 mnd senere)" },
  { id: "mg6", leietaker: "Demokunde 196", bygg: "CC vest", innflytting: "2023-06-13",
    type: "Garanti", belopAvtalt: 396201, status: "I dialog",
    sisteStatusFritekst: null, kilde: "Fenistra 2026-02-27 'Under arbeid' + egen sjekk 2026-09-22 fant heller ingen garanti registrert (samme konklusjon, 7 mnd senere)" },
  { id: "mg7", leietaker: "Demokunde 74", bygg: "CC vest", innflytting: "2023-05-01",
    type: null, belopAvtalt: null, status: "Mangler",
    sisteStatusFritekst: null, kilde: "Fenistra 2026-02-27 'Ikke mottatt' + egen sjekk 2026-09-22 fant heller ingen garanti", usikker: true, usikkerhetsArsak: "Fenistra sin SluttDato for leieforholdet (2026-03-31) har allerede passert - kontrakten er trolig fornyet siden, og denne raden kan gjelde en avsluttet periode. Ingen bekreftelse på at leieforholdet faktisk har et garanti-/depositumskrav i kontrakten - kun en gammel/tynn notis uten beløp, type eller dato å bygge på. Kryssjekk kontraktsvilkårene før dette regnes som en reell oppfølgingssak (Morten 2026-09-26: «mangler garanti» skal kun gjelde der kontrakten krever det)." },
  { id: "mg8", leietaker: "Demokunde 20", bygg: "CC vest", innflytting: "2022-05-01",
    type: null, belopAvtalt: 689885, status: "Mangler",
    sisteStatusFritekst: null, kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering, 2026-02-27), ikke kryssjekket mot noe friskere." },
  { id: "mg9", leietaker: "Demokunde 132", bygg: "CC vest", innflytting: "2020-02-01",
    type: "Garanti", belopAvtalt: null, status: "Mangler",
    sisteStatusFritekst: null, kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering, 2026-02-27), ikke kryssjekket mot noe friskere." },
  { id: "mg10", leietaker: "Demokunde 117", bygg: "CC vest", innflytting: "2023-09-16",
    type: null, belopAvtalt: null, status: "Mangler",
    sisteStatusFritekst: null, kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering, 2026-02-27), ikke kryssjekket mot noe friskere. Ingen bekreftelse på at leieforholdet faktisk har et garanti-/depositumskrav i kontrakten - kun en gammel/tynn notis uten beløp, type eller dato å bygge på. Kryssjekk kontraktsvilkårene før dette regnes som en reell oppfølgingssak (Morten 2026-09-26: «mangler garanti» skal kun gjelde der kontrakten krever det)." },
  { id: "mg11", leietaker: "Demokunde 661", bygg: "CC vest", innflytting: "2020-11-01",
    type: "Garanti", belopAvtalt: 40000, status: "Mangler",
    sisteStatusFritekst: null, kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering, 2026-02-27), ikke kryssjekket mot noe friskere." },
  { id: "mg12", leietaker: "Demokunde 662", bygg: "Gamle Drammensvei 10", innflytting: "2023-04-01",
    type: "Depositum", belopAvtalt: 48000, status: "Mangler",
    sisteStatusFritekst: "Skal økes til 48.000", kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering, 2026-02-27), ikke kryssjekket mot noe friskere." },
  { id: "mg13", leietaker: "Demokunde 663", bygg: "Lilleakerveien 26", innflytting: "2024-05-01",
    type: "Depositum", belopAvtalt: null, status: "Mangler",
    sisteStatusFritekst: "Det er innbetalt 36 094 på depositumskonto hos DnB - må betale et restbeløp på  8906,-.", kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering, 2026-02-27), ikke kryssjekket mot noe friskere." },
  { id: "mg14", leietaker: "Demokunde 32", bygg: "Møller", innflytting: "2014-12-23",
    type: null, belopAvtalt: null, status: "Mangler",
    sisteStatusFritekst: null, kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering, 2026-02-27), ikke kryssjekket mot noe friskere. Ingen bekreftelse på at leieforholdet faktisk har et garanti-/depositumskrav i kontrakten - kun en gammel/tynn notis uten beløp, type eller dato å bygge på. Kryssjekk kontraktsvilkårene før dette regnes som en reell oppfølgingssak (Morten 2026-09-26: «mangler garanti» skal kun gjelde der kontrakten krever det)." },
  { id: "mg15", leietaker: "Demokunde 61", bygg: "CC vest", innflytting: "2023-01-01",
    type: null, belopAvtalt: 2645197, status: "Mangler",
    sisteStatusFritekst: null, kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering, 2026-02-27), ikke kryssjekket mot noe friskere." },
  { id: "mg16", leietaker: "Demokunde 59", bygg: "Vollsveien 13-19", innflytting: "2022-12-01",
    type: "Garanti", belopAvtalt: 2540062, status: "Mangler",
    sisteStatusFritekst: null, kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering, 2026-02-27), ikke kryssjekket mot noe friskere." },
  { id: "mg17", leietaker: "Demokunde 664 AS", bygg: "CC vest", innflytting: "2021-01-01",
    type: "Garanti", belopAvtalt: 620000, status: "Mangler",
    sisteStatusFritekst: null, kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering, 2026-02-27), ikke kryssjekket mot noe friskere." },
  { id: "mg18", leietaker: "Demokunde 665 AS", bygg: "Arnstein Arnebergsvei 4", innflytting: "2025-08-01",
    type: null, belopAvtalt: null, status: "Mangler",
    sisteStatusFritekst: null, kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering, 2026-02-27), ikke kryssjekket mot noe friskere. Ingen bekreftelse på at leieforholdet faktisk har et garanti-/depositumskrav i kontrakten - kun en gammel/tynn notis uten beløp, type eller dato å bygge på. Kryssjekk kontraktsvilkårene før dette regnes som en reell oppfølgingssak (Morten 2026-09-26: «mangler garanti» skal kun gjelde der kontrakten krever det)." },
  { id: "mg19", leietaker: "Demokunde 121", bygg: "CC vest", innflytting: "2023-06-30",
    type: null, belopAvtalt: null, status: "Mangler",
    sisteStatusFritekst: null, kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering, 2026-02-27), ikke kryssjekket mot noe friskere. Ingen bekreftelse på at leieforholdet faktisk har et garanti-/depositumskrav i kontrakten - kun en gammel/tynn notis uten beløp, type eller dato å bygge på. Kryssjekk kontraktsvilkårene før dette regnes som en reell oppfølgingssak (Morten 2026-09-26: «mangler garanti» skal kun gjelde der kontrakten krever det)." },
  { id: "mg20", leietaker: "Demokunde 266 AS", bygg: "Lilleakerveien 31", innflytting: "2026-02-01",
    type: "Depositum", belopAvtalt: null, status: "Mangler",
    sisteStatusFritekst: null, kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering, 2026-02-27), ikke kryssjekket mot noe friskere." },
  { id: "mg21", leietaker: "Demokunde 126", bygg: "CC vest", innflytting: "2019-03-01",
    type: "Garanti", belopAvtalt: 508124, status: "I dialog",
    sisteStatusFritekst: "Leiekontrakt er forlenget - garanti skal forlenges.", kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering, 2026-02-27), ikke kryssjekket mot noe friskere." },
  { id: "mg22", leietaker: "Demokunde 666 AS", bygg: "Lilleakerveien 31", innflytting: "2021-07-01",
    type: "Depositum", belopAvtalt: 126662, status: "I dialog",
    sisteStatusFritekst: null, kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering, 2026-02-27), ikke kryssjekket mot noe friskere." },
  { id: "mg23", leietaker: "Demokunde 172", bygg: "CC vest", innflytting: "2021-01-01",
    type: "Depositum", belopAvtalt: 92000, status: "I dialog",
    sisteStatusFritekst: "Knyttet konto til ny kontrakt. Sent mail til kontaktperson 18.08 og bedt om påfyll fra 56.000 til 92.000", kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering, 2026-02-27), ikke kryssjekket mot noe friskere." },
  { id: "mg24", leietaker: "Demokunde 667", bygg: "Lilleakerveien 31", innflytting: "2023-10-01",
    type: null, belopAvtalt: 29500, status: "I dialog",
    sisteStatusFritekst: "DNB ikke akseptert endring av kontohaver", kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering, 2026-02-27), ikke kryssjekket mot noe friskere." },
  { id: "mg25", leietaker: "Demokunde 39", bygg: "Vollsveien 13-19", innflytting: "2023-07-05",
    type: "Garanti", belopAvtalt: 3537093, status: "I dialog",
    sisteStatusFritekst: "Skal gjelde hele leieperioden", kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering, 2026-02-27), ikke kryssjekket mot noe friskere." },
  { id: "mg26", leietaker: "Demokunde 668", bygg: "Arnstein Arnebergsvei 4", innflytting: "2023-09-01",
    type: "Depositum", belopAvtalt: 45000, status: "I dialog",
    sisteStatusFritekst: "Videreført dep konto for leieforhold på Elsero. eneleietaker. Ny depositumkonto må opprettes.", kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering, 2026-02-27), ikke kryssjekket mot noe friskere." },
  { id: "mg27", leietaker: "Demokunde 29", bygg: "CC vest", innflytting: "2025-08-01",
    type: null, belopAvtalt: null, status: "Mangler",
    sisteStatusFritekst: null, kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering, 2026-02-27), ikke kryssjekket mot noe friskere. Ingen bekreftelse på at leieforholdet faktisk har et garanti-/depositumskrav i kontrakten - kun en gammel/tynn notis uten beløp, type eller dato å bygge på. Kryssjekk kontraktsvilkårene før dette regnes som en reell oppfølgingssak (Morten 2026-09-26: «mangler garanti» skal kun gjelde der kontrakten krever det)." },
  { id: "mg28", leietaker: "Demokunde 195", bygg: "Vollsveien 13D", innflytting: "2025-10-01",
    type: "Depositum", belopAvtalt: null, status: "Mangler",
    sisteStatusFritekst: null, kilde: "SharePoint Garantioversikt (Fenistra), snapshot 2026-02-27", usikker: true, usikkerhetsArsak: "Kun bekreftet i Fenistra-eksporten (pre-migrering, 2026-02-27), ikke kryssjekket mot noe friskere." },
];
...
export function buildDashboardContext(): string {
  ...
  lines.push(
    `\nGARANTIOVERSIKT (ekte, Salesforce/SharePoint/Asana/Outlook/Teams, ${GUARANTEES_SIST_OPPDATERT}): ${HAR_GARANTI.length} leietakere har sikret garanti, ${MANGLER_GARANTI.length} mangler`,
  );
  for (const g of MANGLER_GARANTI) lines.push(`- [${g.status}] ${g.leietaker}${g.bygg ? ` (${g.bygg})` : ""}${g.usikker ? " (usikker)" : ""}`);
